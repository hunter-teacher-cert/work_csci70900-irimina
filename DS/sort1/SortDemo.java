//Team: Victoria Berkowitz, Benson Leung, Eric Wilson, Iulian J Irimina
...
public class SortDemo{
    ...
    */
    ...
    int valueSmallestIndex= findSmallestIndex(i);
       int temp = data.get(i);
       data.set(i, valueSmallestIndex);
       data.set(valueSmallestIndex, temp);
	...
	public int binarySearch(int value){
	    ...
	    int lowerIndex = 0;
	    int upperIndex = data.size(); // shouldn't it be data.size() -1;
